...
* Haskell's type inference is built on an extended version of the [Damas-Hindley-Milner type system](https://en.wikipedia.org/wiki/Hindley%E2%80%93Milner_type_system)
...
* If we want to ensure that our input and result are only integers then we would declare it:
		...
		-- Not the typeclass constraint is gone
